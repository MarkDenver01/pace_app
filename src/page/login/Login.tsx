...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-orange-500 flex items-center justify-center relative overflow-hidden">

      {/* 🔵 floating circles background (LEFT PANEL vibes) */}
      <div className="absolute -left-20 -top-20 w-72 h-72 bg-orange-300/40 rounded-full blur-3xl animate-pulse" />
      <div className="absolute left-10 top-64 w-40 h-40 bg-orange-200/40 rounded-full blur-2xl animate-bounce" />
      <div className="absolute left-32 bottom-10 w-52 h-52 bg-orange-400/30 rounded-full blur-3xl animate-pulse" />

      {/* CONTAINER */}
      <div className="w-full max-w-6xl min-h-[550px] bg-white/80 backdrop-blur-lg rounded-xl overflow-hidden shadow-2xl grid grid-cols-1 md:grid-cols-2">

        {/* LEFT PANEL */}
        <div className="relative bg-gradient-to-br from-orange-500 to-orange-600 p-6 flex flex-col items-center justify-center text-center">

          <img src={PaceLogo} className="h-24 mb-2 animate-fadeIn" />

          <p className="text-white/90 text-sm mb-6 animate-slideUp">
          ...
          <img
            src={HeroStudent}
            className="h-64 drop-shadow-[0_20px_40px_rgba(0,0,0,0.45)] animate-floating"
          />

          {/* glow under mascot */}
          <div className="absolute bottom-12 w-40 h-6 bg-white/30 blur-2xl" />
        </div>

        {/* RIGHT PANEL */}
        <div className="bg-orange-50 p-8 flex flex-col justify-center animate-fadeIn">
          ...
          <form className="space-y-4 animate-slideUp" onSubmit={handleLogin}>
            {/* EMAIL */}
            <div>
            ...
            <button
              ...
              className="
                ...
                hover:bg-orange-700 transition shadow-lg hover:shadow-xl
