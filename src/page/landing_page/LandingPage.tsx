...
const PaceLandingPage: FC = () => {
  ...
  const handleBgLeave = () => setBgParallax({ x: 0, y: 0 });
  ...
  return (
    <div className="min-h-screen w-full bg-black font-poppins text-gray-900">
      ...
      >
        {/* Gradient layers */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#00000035]" />
        ...
        >
          {/* Left text block */}
          <div className="max-w-md space-y-4 md:space-y-5" data-animate="fade-right">
          ...
          <div className="hero-image-wrapper" data-animate="fade-left">
            <img src={HeroStudent} alt="Student" className="hero-image" style={heroImageStyle} />
          </div>
        </div>
      </section>
      ...
      <section id="about" className="bg-white px-4 py-14 md:px-6 md:py-16">
        <div className="mx-auto max-w-4xl" data-animate="fade-up">
          ...
          <p className="mt-4 text-justify text-[11px] leading-relaxed text-gray-700 md:text-sm">
            PACE (Personal Academic & Career Evaluation) is an innovative platform designed to help
            students discover their ideal academic paths and future careers—while giving institutions
            the tools to evaluate, guide, and track learner progress.
          </p>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-4xl text-center" data-animate="fade-up">
          ...
          <p className="mt-4 text-[11px] leading-relaxed text-gray-800 md:text-sm">
            Our mission is to empower every learner to discover their path and every institution to
            guide them with purpose. PACE merges psychology, education, and technology to create
            future-ready guidance for all.
          </p>
        </div>
      </section>
