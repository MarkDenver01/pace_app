...
export default function Dashboard() {
  ...
  const loadTopCourses = async () => {
    ...
    try {
      ...
      const courses: TopCourseResponse[] = await getTopCourses(
        universityId,
        currentMonth
      );
  ...
  const loadTopCompetitors = async () => {
    if (!universityId) return;
    try {
      const competitors: TopCompetitorResponse[] = await getTopCompetitors(
        universityId
      );
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                fontSize:
                  card.label === "Top 5 Courses" ||
                  card.label === "Top 3 Competitor Schools"
                    ? "1rem"
                    : valueStyle.fontSize,
                overflow: "hidden",
